        ...
        */
        FP.moveSectionUp = function(){
            ...
            if(Sys.chrome  || Sys.safari){
                var currentUrl = FP.renderUrl($(SECTION_ACTIVE_SEL).children().children().css("background-image"));
                ...
                if($(SECTION_ACTIVE_SEL).prev().length){
                    nextUrl = FP.renderUrl($(SECTION_ACTIVE_SEL).prev().children().children().css("background-image"));
                    //next to color
         ...
         */
         FP.renderUrl = function(url){
             // url("xxxx"")
             var reg = /url\(("|'|)(.+)("|'|)\)/ig;
             (url||"").match(reg);
             var newUrl = RegExp.$2.replace(/(\s|'|")/,'');
             return 'url("'+newUrl+'")';
        }
        ...
        */
        FP.moveSectionDown = function (){
            ...
            if(Sys.chrome || Sys.safari){
                ...
                if($(SECTION_ACTIVE_SEL).next().length && $(SECTION_ACTIVE_SEL).next().hasClass("section")){
                    nextUrl =  FP.renderUrl($(SECTION_ACTIVE_SEL).next().children().children().css("background-image"));
                    //next to color
                    nextUrl = nextUrl.substring(0,nextUrl.length-6)+"_c.jpg\")";
                    nextUrl = nextUrl.replace("_c_c","_c");
